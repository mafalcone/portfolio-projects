...
export function FinalTop({ view = 'projects', setView = () => {}, navigateTo = () => {} }) {
  ...
  return <>
    ...
    <section className="hero-dashboard" id="about">
      <div className="portrait-card"><img src="/profile-photo.jpg" alt="Manuel Falcone" /><div className="portrait-fallback">MF</div></div>
      <div className="hero-copy">
        <p className="hello">Hello, I'm</p>
        <h1>MANUEL FALCONE</h1>
        <h2>IT Infrastructure &amp; Support | Automation | Security | Software</h2>
