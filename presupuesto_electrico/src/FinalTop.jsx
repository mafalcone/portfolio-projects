...
export function FinalTop({ view = 'projects', setView = () => {} }) {
  ...
  return <>
    <header className="topbar">
      ...
      <nav className="nav-links">
        <a className={view === 'projects' ? 'active' : ''} href="#projects" onClick={showProjects}>Projects</a>
        <a href="#about">About</a>
        <a href="#skills" onClick={toggleSkills}>Skills</a>
        <a className={view === 'experience' ? 'active' : ''} href="#experience" onClick={showExperience}>Experience</a>
